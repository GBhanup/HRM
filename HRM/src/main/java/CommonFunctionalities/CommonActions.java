	...
	/**
	   ...
	   */
		 ...
		 */
				...
				public static String text(int sheetNo,int row,int cell) throws IOException
				{
					String text=excelRead("C:\\sheets\\AddNewValid.xlsx",sheetNo,row,cell);
					return text;

				}
				public static String excelRead(String path,int sheetNo,int row,int cell) throws IOException
				{
